  ...
  return (
    <div className="border-b border-slate-100 last:border-b-0">
      <button
        ...
        className="w-full py-3 flex items-center justify-between hover:bg-slate-50 transition-colors px-4"
      >
        <span className="text-sm text-slate-700 text-left">{question}</span>
        {isOpen ? (
          <IoRemoveOutline className="w-5 h-5 text-slate-500 flex-shrink-0" />
        ) : (
          <IoChevronForwardOutline className="w-5 h-5 text-slate-500 flex-shrink-0" />
        )}
      </button>
      {isOpen && answer && (
...
export default function HelpSupportPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-white rounded shadow-sm border border-slate-100 p-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-600 mb-3">
                  ...
                  <a href="/scan" className="text-blue-600">
                    Scan
                  </a>{" "}
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <div className="p-2 bg-blue-100 rounded-lg">
                <IoBarChartOutline className="w-5 h-5 text-blue-600" />
              </div>
              <div className="flex-1">
                <h4 className="text-sm font-semibold text-slate-800 mb-1">
        ...
        <div className="bg-white rounded shadow-sm border border-slate-100 p-5">
          ...
          <div className="bg-slate-50 rounded-lg p-4 mb-3 opacity-60">
            <div className="flex items-start gap-3">
              <div className="p-2 bg-blue-100 rounded-lg">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-600">
                  ...
                  <a href="/sandbox" className="text-blue-600">
                    Sandbox
                  </a>{" "}
      ...
      {/* FAQs Section */}
      <div className="bg-white rounded shadow-sm border border-slate-100 mb-6">
      ...
      <div className="bg-white rounded shadow-sm border border-slate-100 p-5 mb-6">
        <h3 className="text-base font-semibold text-slate-800 mb-4">
          About IsoLens
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Gateway Version:</span>
            <span className="text-sm text-slate-800 font-mono">{version}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Developed as part of:</span>
            <span className="text-sm text-slate-800">S6 Mini Project</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Source Code:</span>
            <a
